        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpericenPoints = table.Column<int>(type: "integer", nullable: false),
                    Inactive = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdateAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QuizOptionAnswers_QuizAnswers_QuizAnswerId",
                        column: x => x.QuizAnswerId,
                        principalTable: "QuizAnswers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QuizOptionAnswers_QuizOptions_QuizOptionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizOptionAnswers_QuizAnswerId",
                table: "QuizOptionAnswers",
                column: "QuizAnswerId");

            migrationBuilder.CreateIndex(
                name: "IX_QuizOptionAnswers_QuizOptionId",
                table: "QuizOptionAnswers",
                column: "QuizOptionId");
